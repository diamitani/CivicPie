        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Connect with your ward, alderman, and local government. 
              Get personalized answers about your neighborhood with CivicGuide AI.
            </p>
            ...
            >
              ...
              <div className="text-center lg:text-left">
                <div className="text-3xl font-bold text-white">2.7M</div>
            ...
            <div className="relative">
              ...
              <div className="glass-card rounded-3xl p-6 shadow-2xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900">CivicGuide</div>
                ...
                <div className="space-y-3">
                  <div className="flex gap-3">
                    ...
                    <div className="bg-slate-100 rounded-2xl rounded-tl-sm px-4 py-2 text-sm text-slate-700">
                      When is the next 43rd ward meeting?
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 flex-row-reverse">
                    ...
                    <div className="bg-blue-600 rounded-2xl rounded-tr-sm px-4 py-2 text-sm text-white max-w-xs">
                      The next 43rd Ward meeting is March 15th at 7 PM at the Lincoln Park Library. Agenda items include zoning changes for 2400 N Lincoln and budget discussions.
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3 flex-row-reverse">
                    ...
                    <div className="bg-blue-600 rounded-2xl rounded-tr-sm px-4 py-2 text-sm text-white">
                      Timothy R. Knudsen represents the 43rd Ward. Would you like contact info or recent voting records?
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="font-semibold text-slate-900">All 50 Wards</div>
              </motion.div>
            </div>
          </motion.div>
        </div>
